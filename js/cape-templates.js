...
// filter-form
template = "    <div class='filter-form'>\n        <div v-for=\"filter in filters\" :key=\"filter.field.id\" class=\"form-row mb-1\">\n            <div class=\"col-sm-2 text-sm-right\">\n                <label v-if=\"filter.field.description != null\" data-toggle=\"tooltip\" v-bind:title=\"filter.field.description\" v-bind:for=\"'filter-'+filter.field.id\">{{filter.field.label}}<\/label>\n                <label v-else v-bind:for=\"'filter-'+filter.field.id\">{{filter.field.label}}<\/label>\n            <\/div>\n            <template v-if=\"filter.field.type=='text'\">\n                <div class=\"col-sm-2\">\n                    <select v-model.trim=\"filter.mode\" class=\"filter-form-field-searchtype \">\n                        <option value=\"is\">is<\/option>\n                        <option value=\"contains\">contains<\/option>\n                        <option value=\"set\">is present<\/option>\n                        <option value=\"not-set\">is not present<\/option>\n                    <\/select>\n                <\/div>\n                <div class=\"col-sm-8\">\n                    <template v-if=\"filter.mode=='is' || filter.mode=='contains'\">\n                        <debounced-input v-bind:type=\"'text'\" v-bind:id=\"'filter-'+filter.field.id\" v-model.trim=\"filter.term\" v-bind:placeholder=\"filter.placeholder[filter.mode]\" class=\" \"><\/debounced-input>\n                    <\/template>\n                <\/div>\n            <\/template>\n            <template v-else-if=\"filter.field.type=='integer'\">\n                <div class=\"col-sm-2\">\n                    <select v-model.trim=\"filter.mode\" class=\"filter-form-field-searchtype \">\n                        <option value=\"is\">is<\/option>\n                        <option value=\"between\">is between<\/option>\n                        <option value=\"set\">is present<\/option>\n                        <option value=\"not-set\">is not present<\/option>\n                    <\/select>\n                <\/div>\n                <div class=\"col-sm-8\">\n                    <template v-if=\"filter.mode=='is'\">\n                        <debounced-input v-bind:type=\"'number'\" v-bind:id=\"'filter-'+filter.field.id\" v-model.trim=\"filter.term\" v-bind:placeholder=\"filter.placeholder.is\" class=\" \" v-bind:min=\"filter.field.min\" v-bind:max=\"filter.field.max\"><\/debounced-input>\n                    <\/template>\n                    <template v-if=\"filter.mode=='between'\">\n                        <debounced-input v-bind:type=\"'number'\" v-bind:id=\"'filter-'+filter.field.id\" v-model.number=\"filter.term\" v-bind:placeholder=\"filter.placeholder.between[0]\" class=\"  between-number-filter\" v-bind:min=\"filter.field.min\" v-bind:max=\"filter.field.max\"><\/debounced-input>\n                        and\n                        <debounced-input v-bind:type=\"'number'\" v-bind:id=\"'filter-'+filter.field.id\" v-model.number=\"filter.term2\" v-bind:placeholder=\"filter.placeholder.between[1]\"  class=\"  between-number-filter\" v-bind:min=\"filter.field.min\" v-bind:max=\"filter.field.max\"><\/debounced-input> \n                    <\/template>\n                <\/div>\n            <\/template>\n            <template v-else-if=\"filter.field.type=='date'\">\n                <div class=\"col-sm-2\">\n                    <select v-model.trim=\"filter.mode\" class=\"filter-form-field-searchtype \" v-bind:id=\"'filter-'+filter.field.id\">\n                        <option value=\"is\">is<\/option>\n                        <option value=\"between\">is between<\/option>\n                        <option value=\"set\">is present<\/option>\n                        <option value=\"not-set\">is not present<\/option>\n                    <\/select>\n                <\/div>\n                <div class=\"col-sm-8\">\n                    <template v-if=\"filter.mode=='is'\">\n                        <debounced-input v-bind:type=\"'text'\" v-model.trim=\"filter.term\" v-bind:placeholder=\"filter.placeholder.is\" class=\" \" v-bind:id=\"'filter-'+filter.field.id\"><\/debounced-input>\n                    <\/template>\n                    <template v-if=\"filter.mode=='between'\">\n                        <debounced-input v-bind:type=\"'text'\" v-model.trim=\"filter.term\" v-bind:placeholder=\"filter.placeholder.between[0]\" class=\"  between-number-filter\" v-bind:id=\"'filter-to-'+filter.field.id\"><\/debounced-input>\n                        and\n                        <debounced-input v-bind:type=\"'text'\" v-model.trim=\"filter.term2\" v-bind:placeholder=\"filter.placeholder.between[1]\" class=\"  between-number-filter\" v-bind:id=\"'filter-from-'+filter.field.id\"><\/debounced-input>\n                    <\/template>\n                <\/div>\n            <\/template>\n            <template v-else-if=\"filter.field.type=='enum'\">\n                <div class=\"col-sm-2\">\n                    <select v-model.trim=\"filter.mode\" class=\"filter-form-field-searchtype \">\n                        <option value=\"is\">is<\/option>\n                        <option value=\"one-of\">one of<\/option>\n                        <option value=\"set\">is present<\/option>\n                        <option value=\"not-set\">is not present<\/option>\n                    <\/select>\n                <\/div>\n                <div class=\"col-sm-8\">\n                    <template v-if=\"filter.mode=='is'\">\n                        <select v-model=\"filter.term\" class=\"\" v-bind:id=\"'filter-'+filter.field.id\">\n                            <option selected=\"selected\" value=\"\">Select<\/option>\n                            <option v-for=\"option in filter.field.options\" v-bind:value=\"option\">{{ option }}<\/option>\n                        <\/select>\n                    <\/template>\n                    <template v-if=\"filter.mode=='one-of'\">\n                        <multiselect v-model=\"filter.terms\" :options=\"filter.field.multiselectOptions\" :multiple=\"true\" :close-on-select=\"true\" :clear-on-select=\"false\" :preserve-search=\"true\" placeholder=\"Select (1 or more)\" label=\"name\" track-by=\"name\" >\n                            <template slot=\"tag\" slot-scope=\"{ option, remove }\"><span class=\"custom__tag\"><span>{{ option.name }}<\/span><span class=\"custom__remove\" @click=\"remove(option)\">\u274c<\/span><\/span><\/template>\n                        <\/multiselect>\n                    <\/template>\n                <\/div>\n            <\/template>\n            <template v-else-if=\"filter.field.type=='freetext'\">\n                <div class=\"col-sm-10\">\n                    <debounced-input v-bind:type=\"'text'\" v-model.trim=\"filter.term\" class=\" \" v-bind:id=\"'filter-'+filter.field.id\"><\/debounced-input>\n                <\/div>\n            <\/template>\n            <template v-else>\n                <div class=\"col-sm-10\">\n                   Unknown filter type.\n                <\/div>\n            <\/template>\n        <\/div>\n    <\/div>\n";

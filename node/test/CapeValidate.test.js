...
describe('validateNonEmptyArrayProperty', ()=>{
    ...
    it('Throw error when passed property is empty array', () => {
        expect( ()=>{CapeValidate.validateNonEmptyArrayProperty('tester',{'foo':[]},'foo')} ).to.throw( CapeValidationError );
    });
});
});
